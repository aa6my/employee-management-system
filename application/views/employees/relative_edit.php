                ...
                <form action="employees/save_relative" method="POST" id="save_relative">
                    ...
                    <div class="col-lg-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <input type="text" name="birht_date" id="birht_date" class="form-control datetimepicker" value="<?= $relative['birht_date']?date($this->config->item('date_format'),strtotime($relative['birht_date'])):''?>" data-date-format="<?= $this->config->item('js_month_format')?>">
                        </div>
                    </div>
                    <div class="col-lg-6" style="padding-left: 0;">
                        <div class="form-group">
