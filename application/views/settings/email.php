                        ...
                        <div class="row">
                            <form role="form" action="settings/save_email" method="POST" id="save_email">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="email_method" class="form-control required" id="email_method">
                                            ...
                                            <option value="email" <?= ($email['email_method']=='mail'?'selected="selected"':'')?>><?= $this->lang->line('Mail')?></option>
                                ...
                                <div id="smtp_settings" class="<?= ($email['email_method']=='smtp'?'':'hide')?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group has-feedback">
                                            <label class="control-label" for="smtp_password"><?= $this->lang->line('SMTP password')?></label>
