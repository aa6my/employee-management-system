...
class Api extends REST_Controller
{
     ...
     *          eg : ems/key/employee_id/val/42
     *
     *          example Full url : ems/type/employees/key/employee_id/val/12
     *          
     ...
     *          eg : joinid/employee_id @@ if want to add more than one join, separeted by '-' respectively
     ...
     *          ex : jointo/mailbox_employees
     *          eg : if more than one - ems/type/employees/joinid/employee_id-thread_id/jointo/employees-mailbox_employees          
     * 
     **************************************************************************************************/
    ...
    public function dataAll_post()
     {
        ...
        $insert    = $this->Api_model->insert_new_data($arrayData,$table);
