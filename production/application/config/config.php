...
$config['attachment_files']=array('doc','docx','xls','xlsx','gif','jpeg','jpg','pdf','txt','png','ppt','pptx','mp3','mp4','avi','wmv','mpg','dat','flv','rtf','rar','wav','zip','csv');
$config['max_file_size']='2000';

$config['possible_permissions']=array('employees','skills','performance','discipline','timeoff','admin','recruiting');
